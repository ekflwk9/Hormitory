...
public class MonsterAIController : MonoBehaviour
{
    ...
    public void PlayRandomSound()
    {
        ...
        talkSource.clip = SoundManager.GetSfxClip(SoundCategory.Movement, $"BattleMonster{index + 1}");
        talkSource.Play();
    ...
    {
        sfxSource.clip = SoundManager.GetSfxClip(SoundCategory.Movement, "BattleMonsterFly");
        sfxSource.Play();
    }
